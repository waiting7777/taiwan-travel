<template>
  <div class="main" :class="{ active: modalActive }">
    ...
    <div id="schedule-modal" :class="{ active: modalActive }">
      <div>
        <img src="/images/logo-modal.png" alt="" />
      </div>
...
const carouselData = [
  {
    key: 'food',
    captions: ['談起台灣美食一定不能漏掉鮮嫩多汁、皮薄肉多的小籠包。圖／鼎泰豐提供', '台南擔仔麵是簡單卻回味無窮的傳統小吃。圖／聯合報系資料照', '佛跳牆是許多台灣人必吃的年菜，也是精緻飲食的代表。圖／聯合報系資料照', '炸得黃金酥脆的排骨酥，也是台灣美食代表。圖／聯合報系資料照'],
  ...
  },
  {
    ...
    text: '台灣的鐵道系統完善，遍布各地區，除了火車外，西部更有高鐵讓你在短時間內抵達重要城市，節省寶貴旅遊時間。火車支線更是風情萬種，如台北的平溪線、新竹的內灣線、南投集集線、嘉義阿里山小火車等沿途風光景致明媚，想要細細品味台灣之美，又不想被不熟的路況、壅塞的車陣所困擾的遊客，鐵道旅行是你最好的體驗方式，沿途的海景、山色、田園、小鎮風光都令人難忘。',
    link: 'https://www.taiwan.net.tw/m1.aspx?sNo=0011550'
  },
  {
    key: 'bus',
    captions: ['濱海公路旁的南雅奇岩，有「霜淇淋」「竹筍」般鬼斧神工的風化砂岩。圖／聯合報系資料照', '新北瑞芳鼻頭角步道，不只可坐擁群山海景，還有一座浪漫白燈塔。圖／聯合報系資料照', '九份老街最熱門的阿妹茶樓。圖／聯合報系資料照', '雪霸國家公園觀霧遊憩區，終年雲霧繚繞，有多條步道，可以近距離欣賞高山生態。圖／雪管處提供'],
  ...
  },
  {
    ...
    text: '單車環島是台灣熱門的深度旅遊方式，台灣擁有絕佳的地理特色，在環島行程中，可見城市地貌、鄉野風光、崎嶇山路，更有壯闊的斷崖、海景。完善的「環島1號線」單車路線，以及補給站沿途提供車手協助。近年來許多熱愛戶外運動的觀光客慕名而來，日月潭自行車道更名列全球10大最美自行車道，環潭乘騎30公里，可飽覽湖光山景。',
  ...
  },
  {
    ...
    link : 'https://www.taiwan.net.tw/m1.aspx?sNo=0000112&keyString=^^^13'
  },
  {
    key: 'north',
    ...
    text: '台灣首都就座落在北部，台北101是全台最高樓，在這裡旅客可俯瞰首都景致，也可前往故宮博物院一窺歷史典藏文物瑰寶；或走進新北市的知名老街如：九份、淡水、鶯歌、三峽等感受古街風情；或體驗基隆市的漁港風情。位於台灣東北角的宜蘭有超過千年的棲蘭神木園，蘇澳可泡冷溫泉放鬆身心。而新竹的舊城亦展現迷人的在地風貌，桃園大溪老街的歷史街屋及拉拉山、慈湖等景點都相當適合安排一日遊。',
  ...
  },
  {
    ...
    text: '中部包括苗栗縣、台中市、彰化縣、南投縣及雲林縣等5個縣市，台中高美濕地的絕佳夕陽和逢甲特色商圈可同時滿足體驗自然與逛街購物。如果你熱愛文藝，那便不可錯過苗栗的木雕與燒陶藝術。彰化的鹿港老街的舊街紅磚道，如同走進時空隧道，而王功漁港是漁業與濕地生態極具特色。雲林縣是揚名世界的布袋戲演藝文化發源地，值得深入欣賞。',
    link: 'https://www.taiwan.net.tw/m1.aspx?sNo=0000502'
  },
  {
    key: 'south',
    captions: ['高雄愛河經過多年整治，呈現全新風貌，高雄市政府引進全新的愛之船遊輪，讓民眾從水上欣賞沿岸風光。圖／聯合報系資料照', '嘉義阿里山的日出與雲海總是吸引眾多旅客起個大早等待美景。圖／台灣觀光局提供', '台江國家公園的四草綠色隧道河景與生態，可搭竹筏瀏覽沿岸風光。圖／聯合報系資料照', '鵝鑾鼻燈塔，光力可達近50公里，被封為「東亞之光」。圖／聯合報系資料照'],
    text: '台灣南部氣候四季如夏，任何季節造訪都非常適合。台南是全台歷史最悠久的文化古都，嘉義阿里山森林遊樂區雲海、高山森林鐵路及林間古道是必遊體驗。海港之都高雄除了愛河、壽山、西子灣、蓮池潭等景點外，還有佛教勝地佛光山可參訪，也有必遊的知名夜市。位處國境之南的屏東墾丁，除了碧海藍天外，墾丁國家公園內的自然生態也是旅遊首選。',
    link: 'https://www.taiwan.net.tw/m1.aspx?sNo=0000503'
  },
  {
    key: 'east',
    captions: ['鹿野高台熱氣球連續獲選為台東TOP10朝聖景點之一。圖／台東縣政府提供', '鹿野高台熱氣球連續獲選為台東TOP10朝聖景點之一。圖／聯合報系資料照', '花蓮太魯閣最典型的山川景觀。圖／聯合報系資料照', '花蓮太魯閣國家公園內白楊步道水簾洞。圖／太管處提供'],
  ...
  {
    key: 'island',
    captions: ['澎湖七美的雙心石滬名揚國際。圖／聯合報系資料照', '澎湖列島是台灣三大火山群之一，海蝕及其他地形作用的影響，形成許多高低起伏、變化多端的柱狀玄武岩。圖／台灣觀光局', '馬祖芹壁聚落。圖／聯合報系資料照', '金門古厝以閩南建築風格為主，大都建在山坳谷間，房屋大小不一，隨地勢錯綜林立。圖／新華社資料照'],
    text: '你知道台灣除了本島以外，還有許多有趣好玩的離島嗎？澎湖、金門與馬祖都屬離島地區，澎湖群島遍布玄武岩地質景觀，大自然鬼斧神工的多樣雕琢，有「上帝的石雕公園」的美稱。碧海藍天的沙灘、古厝及春夏花火節的燦爛煙火都不容錯過。金門與馬祖都曾是歷史上重要的軍事之地，金門三寶「鋼刀、貢糖、高粱酒」及馬祖的老酒與海鮮都不容錯過。',
