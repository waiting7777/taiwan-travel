...
const carouselData = [
  ...
  },
  {
    ...
    text: '台灣的鐵道系統完善，遍布各地區，除了火車外，西部更有高鐵讓你可節省寶貴時間。火車支線更是風情萬種，如台北的平溪線、新竹的內灣線、南投集集線、嘉義阿里山小火車等沿途風光景致明媚，想要細細品味台灣之美，又不想被不熟的路況、壅塞的車陣所困擾的遊客，鐵道旅行是你最好的體驗方式，沿途的海景、山色、田園、小鎮風光都令人難忘。',
  ...
  },
  {
    key: 'middle',
    title: '中部地區',
    captions: ['台中高美濕地成排的風力發電機、夕陽與旅客交織成一幅美景。圖／聯合報系資料照', '彰化縣芳苑鄉王功漁港。圖／台灣觀光局提供', '日月潭萬人泳度活動是每年日月潭最熱血的戶外活動。圖／日管處提供'],
